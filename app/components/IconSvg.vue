<template>
  ...
  >
    ...
    <path
      ...
      <path :fill="dark ? '#ffffff' : '#2C3656'" stroke="#009EFB" stroke-width="1.6" fill-opacity=".2" :d="icons[icon.liga]" />
  </svg>
</template>

<script>
import icons from '../../dist/icons/icons-data.json'

export default {
  props: ['icon', 'size', 'dark'],
  data () {
    return {
      icons: icons,
    }
